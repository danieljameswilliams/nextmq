...
test.describe('Add to Cart Flow', () => {
  test('should show notification dialog when Add to Cart button is clicked', async ({ page }) => {
  ...
  test('should dispatch CustomEvent when Add to Cart button is clicked', async ({ page }) => {
    await page.goto('/')
    await page.waitForLoadState('networkidle')
  ...
  test('should process job and render notification via NextMQ', async ({ page }) => {
    await page.goto('/')
    await page.waitForLoadState('networkidle')
