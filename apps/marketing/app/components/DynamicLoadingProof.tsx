...
import { Code2, CheckCircle2, Monitor, Zap, Bell, Layout, BarChart } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-950 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Click the buttons below to dispatch jobs. Each handler is loaded dynamically when first used.
          Open DevTools → Network tab to see chunks loading in real-time.
        </p>
        ...
        <div className="space-y-4">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              {triggeredHandlers.has('demo.notification') && (
            ...
            >
              ...
              {triggeredHandlers.has('demo.portal') && (
            ...
            >
              ...
              {triggeredHandlers.has('demo.analytics') && (
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-green-800 dark:text-green-200">
                  Check the Network tab in DevTools to see the chunk files loading dynamically.
                  Each handler is in its own separate chunk file.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-2 mb-2">
              ...
              <div className="flex-1">
                ...
                <ol className="list-decimal list-inside mt-2 space-y-1 text-sm text-blue-800 dark:text-blue-200">
                  ...
                  <li>Watch new chunk files appear (e.g., <code className="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">handlers_demoNotification.js</code>)</li>
...
return handler.default(job);`} language="javascript" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-950 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          NextMQ can be called from anywhere, even external scripts and partner integrations.
          No React context needed - just dispatch a CustomEvent.
        </p>
