...
export default async function cartAddHandler(job: Job<{ ean: string; quantity: number }>): Promise<ReactElement | undefined> {
  ...
  return (
    ...
    >
      <div style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>Added to Cart!</div>
